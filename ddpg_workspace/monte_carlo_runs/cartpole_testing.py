...
#u_max = 12
n_samples = 500 # number of monte carlo samples

path_to_save = "results/Cartpole/exp_0/data.txt"
f = open(path_to_save, "a")


for i in frange(0.0, 0.22, 0.02):
    ...
    for j in range(n_samples):
        ...
        history, state_history, episode_reward = agent.test(env, nb_episodes=1, visualize=False, action_repetition=1, \
            nb_max_episode_steps=STEPS_PER_EPISODE, initial_state=[0, np.pi, 0, 0], std_dev_noise=0, gamma=GAMMA, process_noise_std=i)
