...
filename_exp = 'exp_0005'
log_filename_pre = '../results/Swimmer3/'
process_noise_std = 0.006
theta=0.15
...
# agent.fit(env, nb_steps=2000000, visualize=False, callbacks=callbacks, verbose=1, gamma=GAMMA, nb_max_episode_steps=STEPS_PER_EPISODE, process_noise_std=process_noise_std)
...
agent.load_weights('../results/Swimmer3/'+filename_exp +'/ddpg_{}_weights.h5f'.format(ENV_NAME))
