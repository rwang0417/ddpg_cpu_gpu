import numpy as np
from half_cheetah import agent 
from half_cheetah import env, GAMMA, STEPS_PER_EPISODE
...
path_to_save = "../results/HalfCheetah/exp_1/data.txt"
...
for i in frange(0.0, 1.02, 0.05):
    ...
    for j in range(n_samples):
        ...
        history, state_history, episode_reward = agent.test(env, nb_episodes=1, visualize=False, action_repetition=1, \
            nb_max_episode_steps=STEPS_PER_EPISODE, initial_state=np.zeros((17,)), std_dev_noise=i*u_max, gamma=GAMMA)
